const comment = require("../../assets/images/png/comment.png");
const message = require("../../assets/images/png/message.png");
const cleaning = require("../../assets/images/png/bucket.png");
